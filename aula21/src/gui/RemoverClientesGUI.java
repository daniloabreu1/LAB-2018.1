 ...
 * @author Danilo Abreu
 */
public class RemoverClientesGUI extends javax.swing.JDialog {
    ...
    private static RemoverClientesGUI lcg;

    public RemoverClientesGUI(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    static {
        lcg = new RemoverClientesGUI(null, true);
    }

    public static RemoverClientesGUI getInstance() {
        return lcg;
    }
    ...
    private void initComponents() {
        ...
        removetBT.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/Actions-list-remove-user-icon.png"))); // NOI18N
        removetBT.setToolTipText("Remover Cliente");
        removetBT.setEnabled(false);
        removetBT.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                removetBTActionPerformed(evt);
            }
        });
    ...
    private void removetBTActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_removetBTActionPerformed
        ...
        if (arq.regravarDados(f, BufferCliente.apagarCliente(lista, campoId))) {
            preencherTabela();
            JOptionPane.showMessageDialog(this, "Removeu Cliente", "Confirmação", JOptionPane.INFORMATION_MESSAGE);

        } else {
            JOptionPane.showMessageDialog(this, "Não é possivel fazer a remoção", "Falha Remoção", JOptionPane.ERROR_MESSAGE);
        }

        preencherTabela();


    }//GEN-LAST:event_removetBTActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RemoverClientesGUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                RemoverClientesGUI dialog = new RemoverClientesGUI(new javax.swing.JFrame(), true);
    ...
    private javax.swing.JButton removetBT;
